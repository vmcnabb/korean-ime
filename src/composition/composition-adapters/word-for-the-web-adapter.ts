...
export class WordForTheWebAdapter extends ContentEditableAdapter {
    // the implementation in ContentEditableAdapter almost works, but doesn't handle various scenarios.
    // It also can cause Word for the Web to crash in those scenarios.
    @methodNotSupported
